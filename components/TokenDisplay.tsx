...
export const TokenDisplay: React.FC<Props> = ({ tokens, activeToken, onTokenClick }) => {
  return (
        ...
        return (
          <React.Fragment key={idx}>
            <button
              ...
              className={`inline-flex items-center px-2 py-1 rounded text-sm font-medium border transition-all cursor-pointer
                ${isActive 
